...
# --- Streamlit Cloud-এর নতুন ভার্সনের এরর ফিক্স (Compatibility Patch) ---
try:
    import streamlit.elements.image as st_image
    import streamlit.elements.lib.image_utils as img_utils

    if not hasattr(st_image, "image_to_url"):
        st_image.image_to_url = img_utils.image_to_url
except Exception:
    pass
...
def process_interactive_canvas(pil_img, key_suffix):
    ...
    with col1:
        ...
        canvas_result = st_canvas(
            fill_color="rgba(0, 255, 0, 0.2)",  # ড্র্যাগ করলে হালকা সবুজ শেড
            ...
            width=canvas_w,
            height=canvas_h,
            drawing_mode="rect",  # বক্স ড্র্যাগ করার মোড
...
if uploaded_file:
    ...
    if file_type == "pdf":
        ...
        process_interactive_canvas(pil_img, "img")                "text": text_str,
                "x_min": x_min,
                "y_center": y_center,
                "height": height,
            }
